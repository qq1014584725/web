# Generated by Django 2.0 on 2007-11-23 03:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('CoursePractice', models.CharField(choices=[('一般', '一般'), ('较差', '较差'), ('满意', '满意')], max_length=5)),
                ('E_IndustryDynamics', models.CharField(choices=[('从来没有', '从来没有'), ('偶尔', '偶尔'), ('经常', '经常')], max_length=10)),
                ('E_PracticeCombine', models.CharField(choices=[('从来没有', '从来没有'), ('偶尔', '偶尔'), ('经常', '经常')], max_length=10)),
                ('E_UseingCase', models.CharField(choices=[('从来没有', '从来没有'), ('偶尔', '偶尔'), ('经常', '经常')], max_length=10)),
                ('E_DifferentActivity', models.CharField(choices=[('从来没有', '从来没有'), ('偶尔', '偶尔'), ('经常', '经常')], max_length=10)),
                ('F_IndustryDynamics', models.CharField(choices=[('从来没有', '从来没有'), ('偶尔', '偶尔'), ('经常', '经常')], max_length=10)),
                ('F_PracticeCombine', models.CharField(choices=[('从来没有', '从来没有'), ('偶尔', '偶尔'), ('经常', '经常')], max_length=10)),
                ('F_UseingCase', models.CharField(choices=[('从来没有', '从来没有'), ('偶尔', '偶尔'), ('经常', '经常')], max_length=10)),
                ('F_DifferentActivity', models.CharField(choices=[('从来没有', '从来没有'), ('偶尔', '偶尔'), ('经常', '经常')], max_length=10)),
                ('F_TraditionClass', models.CharField(choices=[('从来没有', '从来没有'), ('偶尔', '偶尔'), ('经常', '经常')], max_length=10)),
                ('F_CourseEffect', models.CharField(choices=[('很好', '很好'), ('一般', '一般'), ('没有效果', '没有效果')], max_length=10)),
                ('I_TeacherDirect', models.CharField(choices=[('很好', '很好'), ('一般', '一般'), ('没有效果', '没有效果')], max_length=10)),
                ('O_TeacherDirect', models.CharField(choices=[('很好', '很好'), ('一般', '一般'), ('没有效果', '没有效果')], max_length=10)),
                ('I_TeacherAbility', models.CharField(choices=[('很好', '很好'), ('一般', '一般'), ('没有效果', '没有效果')], max_length=10)),
                ('O_TeacherAbility', models.CharField(choices=[('很好', '很好'), ('一般', '一般'), ('没有效果', '没有效果')], max_length=10)),
                ('ThesisCombinePractice', models.CharField(choices=[('联系紧密', '联系紧密'), ('没有联系', '没有联系'), ('联系一般', '联系一般')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ActivityFrequency', models.CharField(choices=[('从来没有', '从来没有'), ('偶尔', '偶尔'), ('经常', '经常')], max_length=10)),
                ('ActivityContent', models.CharField(choices=[('内容系统性较好', '内容系统性较好'), ('没有系统性', '没有系统性'), ('内容系统性一般', '内容系统性一般')], max_length=10)),
                ('ActivitySatisfy', models.CharField(choices=[('一般', '一般'), ('较差', '较差'), ('满意', '满意')], max_length=10)),
                ('ActivityEffect', models.CharField(choices=[('很好', '很好'), ('一般', '一般'), ('没有效果', '没有效果')], max_length=10)),
